...
{
	public class DynamicTile : ACObject
	{
        ...
        public DynamicTile(Arkcraft.World.ArkWorld world, TileDefinition tileDefinition, int objectId)
            : base(objectId)
		{
			this.world = world;
        ...
        public DynamicTile(Arkcraft.World.ArkWorld world, TilePosition tilePosition, bool proxy, int objectId)
            : base(objectId)
		{
			this.world = world;
