...
using Arkcraft.Tiles.Components;
...
namespace Arkcraft.Tiles
{
    public class TileManager
    {
        ...
        public TileManager(Arkcraft.World.ArkWorld world)
        {
			this.world = world;
        ...
        private class InternalWorldInitializationGenerator : CubeWorldGenerator
        {
            ...
            public override bool Generate(Arkcraft.World.ArkWorld world)
            {
        ...
        public void Save(System.IO.BinaryWriter bw)
        {
            ...
            //Write map size
            //This is written in Arkcraft.Save()
