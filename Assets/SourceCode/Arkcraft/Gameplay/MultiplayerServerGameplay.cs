...
namespace Arkcraft.Gameplay
{
    public class MultiplayerServerGameplay : BaseGameplay, IMultiplayerClientListener, IMultiplayerServerListener
    {
        ...
        public override void Init(Arkcraft.World.ArkWorld world)
        {
            base.Init(world);
        ...
        public override void FillPlayerInventory(Arkcraft.Items.Inventory inventory)
        {
        ...
        public override void DestroyAvatar(Arkcraft.Avatars.Avatar avatar)
        {
