...
namespace Arkcraft.Utils
{
    public class Graphics
    {
        ...
        static public RaycastTileResult RaycastTile(World.ArkWorld world, Vector3 from, Vector3 fwd, float maxDistance, bool ignoreNonSolid, bool ignoreNonClickable)
        {
            Vector3 pos = from;
