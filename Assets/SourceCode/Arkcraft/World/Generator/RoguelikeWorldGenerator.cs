...
namespace Arkcraft.World.Generator
{
    public class RoguelikeWorldGenerator : CubeWorldGenerator
    {
        ...
        public RoguelikeWorldGenerator(ArkWorld world)
        {
            playerStartPosition =
                new TilePosition(
                    LEVEL_HEIGHT / 2,
        ...
        private void InitTileTypes(ArkWorld world)
        {
        ...
        private void CreateBasicLevels(ArkWorld world)
        {
        ...
        private void CreateLevel(ArkWorld world, int level)
        {
