...
namespace Arkcraft.World.Generator
{
    public class TreeWorldGenerator : CubeWorldGenerator
    {
        ...
        public override bool Generate(ArkWorld world)
        {
        ...
        private void PlantTree(int x, int z, ArkWorld world)
        {
			TileManager tileManager = world.tileManager;
        ...
        private bool FreeSpaceAvailable(int x, int y, int z, int radius, int height, ArkWorld world)
        {
			TileManager tileManager = world.tileManager;
        ...
        private void CreateTree(int treeX, int treeY, int treeZ, int trunkHeight, int leavesHeight, int leavesRadius, ArkWorld world)
        {
			TileManager tileManager = world.tileManager;
