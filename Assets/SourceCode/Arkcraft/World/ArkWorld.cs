...
namespace Arkcraft.World
{
    public class ArkWorld
    {
        ...
        public ArkWorldStats stats = new ArkWorldStats();

		public IACListener cwListener;
        public IACFxListener fxListener;
        ...
        public ArkWorld(IACListener cwListener, IACFxListener fxListener)
        {
